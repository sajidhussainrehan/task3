  ...
  return (
    <div className="min-h-screen bg-[#f8fbfa] pb-24" dir="rtl">
      ...
      <div className="relative bg-[#f8fbfa] pt-6 px-6 overflow-hidden">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] text-center relative mb-8 border border-gray-100">
            ...
            <p className="text-[10px] text-gray-400 font-bold italic">
                {Math.floor(((student.points || 0) / 10000) * 100)}% - باقي {Math.max(0, 10000 - (student.points || 0))} نقطة للترتيب التالي
            </p>
        </div>
        ...
        <div className="mb-10 animate-fadeIn text-right">
            ...
            <div className="bg-[#004e31] rounded-[2.5rem] p-8 text-white text-center mb-6 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                    ...
                    <div className="inline-block bg-white/10 backdrop-blur-md px-6 py-2 rounded-full border border-white/10 text-xs font-bold">بناءً على 5 مهارات</div>
                </div>
            </div>
            ...
            <div className="space-y-4">
                {[
                    ...
                    <div key={idx} className="bg-white rounded-3xl p-5 shadow-sm border border-gray-50 flex items-center justify-between group hover:shadow-md transition-all relative">
                        ...
                        <div className="text-xl ml-4 opacity-40">{skill.icon}</div>
                    </div>
                ))}
            </div>
        </div>
        ...
        <div className="mb-8 text-right">
            ...
            <div className="grid grid-cols-3 gap-4">
                {[
                    { label: "مقاطع الفيديو", icon: "📹", color: "bg-purple-100 text-purple-600" },
                    { label: "الاستثمارات", icon: "📈", color: "bg-blue-100 text-blue-600" },
                    { label: "المبادرات", icon: "🚩", color: "bg-emerald-100 text-emerald-600" },
                    { label: "الحلقة", icon: "✅", color: "bg-orange-100 text-orange-600" },
                    { label: "المسابقات", icon: "🏆", color: "bg-red-100 text-red-600" },
                    { label: "الحضور", icon: "📅", color: "bg-sky-100 text-sky-600" },
                    { label: "كشف الحساب", icon: "📄", color: "bg-rose-100 text-rose-600" },
                    { label: "الترتيب", icon: "📊", color: "bg-teal-100 text-teal-600", link: "/league" },
                    { label: "الكتب", icon: "📚", color: "bg-indigo-100 text-indigo-600" },
                ].map((s, idx) => (
                    s.link ? (
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-8 py-3 flex justify-between items-center z-50">
        ...
        <Link to="/league" className="bg-[#006d44] w-12 h-12 rounded-2xl flex items-center justify-center -mt-10 shadow-lg shadow-emerald-200 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
