      ...
      {activeTab === "manage" ? (
        ...
        <div className="space-y-4">
          {submissions.length === 0 ? (
            ...
            submissions.map((sub) => (
              <div key={sub.id} className="bg-white rounded-2xl p-6 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <form onSubmit={submitReview} className="flex flex-wrap gap-3 items-center pt-4 border-t border-dashed">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="bg-green-500 text-white px-6 py-2 rounded-lg font-bold border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] disabled:opacity-50"
                    >
                      قبول وإضافة النقاط
                    </button>
                    <button
                      ...
                      className="bg-red-500 text-white px-6 py-2 rounded-lg font-bold border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] disabled:opacity-50"
                    >
                      رفض
                    </button>
                  </div>
